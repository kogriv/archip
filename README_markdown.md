...
В Markdown стандартный синтаксис не предусматривает непосредственно нумерованные таблицы, но вы можете имитировать нумерацию, добавив дополнительный столбец для номеров строк.